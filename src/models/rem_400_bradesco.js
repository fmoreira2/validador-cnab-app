//layout arquivo remessa 400 banco Bradesco
const Header = {
  //Posição 001 a 001
  identRegistro: "",
  //Posição 002 a 002
...
var Rem_400_bradesco = {};

exports.bradesco_setNomeArquivo = function (nomeArquivo) {
  Rem_400_bradesco["nomeArquivo"] = nomeArquivo;
};

exports.bradesco_analisarHeader = function (index, line) {
  let _header = null;
...
exports.bradesco_analisarBody = function (index, line) {
  let _body = null;
...
exports.bradesco_analisarTrailler = function (index, line) {
  let i = index - 1;
  let _trailler = null;
  _trailler = Trailler;
...
exports.bradesco_setNovoCnab = function () {
  Rem_400_bradesco = Object.create(layout);
  Rem_400_bradesco.header = [];
  Rem_400_bradesco.body = [];
  Rem_400_bradesco.trailler = [];
  return Rem_400_bradesco;
};
